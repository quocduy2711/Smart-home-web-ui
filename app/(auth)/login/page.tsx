    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-neutral-50 p-4">
            <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-sm border border-neutral-200">
                ...
                <p className="text-neutral-600 mb-6 text-sm">Điều khiển ngôi nhà thông minh của bạn.</p>
                ...
                <form action={action} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={isPending}
                        className="w-full bg-neutral-900 text-white font-bold py-3 rounded-xl hover:bg-neutral-800 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isPending ? "Đang xử lý..." : "Vào hệ thống"}
                    </button>
                    ...
                    <button
                        type="button"
                        onClick={() => alert("Tính năng này cần Google Client ID & Secret để hoạt động!")}
                        className="w-full flex items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2 text-neutral-700 hover:bg-gray-50 transition-colors font-medium"
                    >
                ...
                <p className="mt-6 text-center text-sm text-neutral-600 font-medium">
                    Chưa có tài khoản? <Link href="/register" className="text-neutral-900 font-bold hover:underline">Đăng ký ngay</Link>
                </p>
            </div>
        </div>
    );
